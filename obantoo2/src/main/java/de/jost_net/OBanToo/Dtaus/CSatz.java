...
public class CSatz extends Satz
{
   ...
   * (müsste eigentlich Betrag in Cent heißen)
   */
  ...
  public void setTextschluessel(int value) throws DtausException
  {
    ...
    else if (textschluessel == 5)
    {
      if (textschluesselergaenzung == 0 || textschluesselergaenzung == 1
          || textschluesselergaenzung == 2 || textschluesselergaenzung == 3
          || textschluesselergaenzung == 4 || textschluesselergaenzung == 5
          ...
          || textschluesselergaenzung == 15 || textschluesselergaenzung == 19
          || textschluesselergaenzung == 20 || textschluesselergaenzung == 21
          || textschluesselergaenzung == 71 || textschluesselergaenzung == 73
          || textschluesselergaenzung == 200 || textschluesselergaenzung == 201
          || textschluesselergaenzung == 202 || textschluesselergaenzung == 210
          || textschluesselergaenzung == 222 || textschluesselergaenzung == 230
          || textschluesselergaenzung == 240 || textschluesselergaenzung == 242
          || textschluesselergaenzung == 444 || textschluesselergaenzung == 888
          || (textschluesselergaenzungStr.length() == 3
              && textschluesselergaenzungStr.endsWith("9")))
      {
        zulaessig = true;
      }
    }
    ...
    else if (textschluessel == 15 && (textschluesselergaenzung == 0
        || isEUStaat(textschluesselergaenzung)))
    {
      zulaessig = true;
    }
    else if (textschluessel == 51)
    {
      if (textschluesselergaenzung == 0 || textschluesselergaenzung == 200
          || textschluesselergaenzung == 210 || textschluesselergaenzung == 211
          || textschluesselergaenzung == 212 || textschluesselergaenzung == 220
          || textschluesselergaenzung == 221 || textschluesselergaenzung == 230
          || textschluesselergaenzung == 240 || textschluesselergaenzung == 241
          || textschluesselergaenzung == 401 || textschluesselergaenzung == 402
          || textschluesselergaenzung == 403 || textschluesselergaenzung == 405
          || textschluesselergaenzung == 406 || textschluesselergaenzung == 407
          || textschluesselergaenzung == 408 || textschluesselergaenzung == 409
          || textschluesselergaenzung == 410 || textschluesselergaenzung == 411
          || textschluesselergaenzung == 412 || textschluesselergaenzung == 413
          || textschluesselergaenzung == 444 || textschluesselergaenzung == 445
          || textschluesselergaenzung == 484 || textschluesselergaenzung == 485
          || textschluesselergaenzung == 486 || textschluesselergaenzung == 487
          || textschluesselergaenzung == 488 || textschluesselergaenzung == 489
          || textschluesselergaenzung == 501 || textschluesselergaenzung == 502
          || textschluesselergaenzung == 503 || textschluesselergaenzung == 504
          || textschluesselergaenzung == 505 || textschluesselergaenzung == 506
          || textschluesselergaenzung == 507 || textschluesselergaenzung == 509
          || textschluesselergaenzung == 510 || textschluesselergaenzung == 511
          || textschluesselergaenzung == 520 || textschluesselergaenzung == 521
          || textschluesselergaenzung == 571 || textschluesselergaenzung == 573
          || textschluesselergaenzung == 888 || textschluesselergaenzung == 990
          || (textschluesselergaenzungStr.length() == 3
              && textschluesselergaenzungStr.endsWith("9")))
      {
        zulaessig = true;
    ...
    else if (textschluessel == 59)
    {
      zulaessig = true;
        ...
        && (textschluesselergaenzung == 0 || isEUStaat(textschluesselergaenzung)
            || isNonEUStaat(textschluesselergaenzung)))
    {
      zulaessig = true;
    }
  ...
  {
    // texterweiterung 888 ist f�r Schweiz
  ...
  public void setNameEmpfaenger(String value) throws DtausException
  {
    ...
    {
      throw new DtausException(
          e.getMessage() + " im Feld NameEmpfänger des C-Satzes");
    }
  ...
  public void setNameEmpfaenger2(String value) throws DtausException
  {
    ...
    {
      throw new DtausException(
          e.getMessage() + " im Feld NameEmpfaenger2 des C-Satzes");
    }
  }
  ...
  public void setNameAbsender(String value) throws DtausException
  {
    ...
    {
      throw new DtausException(
          e.getMessage() + " im Feld NameAbsender des C-Satzes");
    }
  ...
  public void setNameAbsender2(String value) throws DtausException
  {
    ...
    {
      throw new DtausException(
          e.getMessage() + " im Feld NameAbsender2 des C-Satzes");
    }
  ...
  public void addVerwendungszweck(String value) throws DtausException
  {
    ...
    {
      throw new DtausException(
          e.getMessage() + " im Verwendungszweck des C-Satzes");
    }
  ...
  public void addErweiterung(String value) throws DtausException
  {
    ...
    {
      throw new DtausException(
          e.getMessage() + " im Erweiterungsteil des C-Satzes");
    }
  ...
  public String toString()
  {
    String ret = "Satzlänge=" + this.getSatzlaenge() + ", BLZ erstbeteiligt="
        ...
        + this.getBlzEndbeguenstigt() + ", Kontonummer=" + this.getKontonummer()
        + ", interne Kundennummer=" + this.getInterneKundennummer()
        + ", Textschluessel=" + this.getTextschluessel()
        + ", erstbeauftragtes Institut=" + this.getErstbeauftragtesInstitut()
        + ", Konto Auftraggeber=" + this.getKontoAuftraggeber() + ", Betrag="
        + this.getBetragInCent() + ", Name Empfänger="
        + this.getNameEmpfaenger() + ", Name Empfänger2="
        + this.getNameEmpfaenger2() + ", Name Absender="
        + this.getNameAbsender() + ", Name Absender2=" + this.getNameAbsender2()
        + ", Erweiterungszeichen=" + this.getErweiterungszeichen();
