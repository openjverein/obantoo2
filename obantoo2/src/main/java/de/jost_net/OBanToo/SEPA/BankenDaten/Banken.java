...
public class Banken
{
  private static ArrayList<Bank> banken = new ArrayList<>();

  private static HashMap<String, Bank> bankcodealt = new HashMap<>();

  private static HashMap<String, Bank> bankcodeneu = new HashMap<>();
  ...
  static
  {
    ...
    {
      // Deutschland
      InputStream is = Banken.class.getClassLoader()
