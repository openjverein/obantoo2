...
{
  private static ArrayList<SEPALand> laender = new ArrayList<>();

  private static HashMap<String, SEPALand> laendermap = new HashMap<>();
  static
  {
  ...
  {
    return new SEPALand("DK", "D�nemark", "4!n9!n1!n", "DK5000400440116243");
  }
  ...
  {
    return new SEPALand("GI", "Gibraltar", "4!a15!c",
  ...
  {
    return new SEPALand("GB", "Gro�britannien", "4!a6!n8!n",
  ...
  {
    return new SEPALand("IL", "Israel", "3!n3!n13!n",
  ...
  {
    return new SEPALand("MK", "Mazedonien", "3!n10!c2!n",
        "MK07250120000058984");
  }
  ...
  {
    SEPALand oesterreich = new SEPALand("AT", "�sterreich", "5!n11!n",
  ...
  {
    return new SEPALand("RO", "Rum�nien", "4!a16!c",
  ...
  {
    return new SEPALand("RS", "Serbien", "3!n13!n2!n",
  ...
  {
    return new SEPALand("TR", "T�rkei", "5!n1!c16!c",
