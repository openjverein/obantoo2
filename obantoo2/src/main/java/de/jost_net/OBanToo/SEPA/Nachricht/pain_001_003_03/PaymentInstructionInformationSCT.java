...
@XmlType(name = "PaymentInstructionInformationSCT", propOrder = { "pmtInfId",
    "pmtMtd", "btchBookg", "nbOfTxs", "ctrlSum", "pmtTpInf", "reqdExctnDt",
    "dbtr", "dbtrAcct", "dbtrAgt", "ultmtDbtr", "chrgBr", "cdtTrfTxInf" })
public class PaymentInstructionInformationSCT
{
   ...
   * 
   * @return possible object is {@link PaymentMethodSCTCode }
   * 
   */
   ...
   * 
   * @param value
   *          allowed object is {@link PaymentMethodSCTCode }
   * 
   */
   ...
   * 
   * @return possible object is {@link PaymentTypeInformationSCT1 }
   * 
   */
   ...
   * 
   * @param value
   *          allowed object is {@link PaymentTypeInformationSCT1 }
   * 
   */
   ...
   * 
   * @return possible object is {@link PartyIdentificationSEPA2 }
   * 
   */
   ...
   * 
   * @param value
   *          allowed object is {@link PartyIdentificationSEPA2 }
   * 
   */
