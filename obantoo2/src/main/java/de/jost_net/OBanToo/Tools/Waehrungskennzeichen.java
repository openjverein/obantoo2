...
/**
 * W�hrungskennzeichen gem. ISO 4217 die im internationalen Zahlungsverkehr zur
 * eindeutigen Identifizierung benutzt werden sollten. Quelle:
 * <a href='http://de.wikipedia.org/wiki/ISO_4217'>Wikipedia: ISO 4217</a>
 * 
...
public class Waehrungskennzeichen
{
  ...
  /**
   * Gulden, Niederl�ndische Antillen
   */
  ...
  /**
   * Euro, Europ�ische W�hrungsunion
   */
  ...
  /**
   * Pfund, Gro�britannien und Nordirland
   */
  ...
  /**
   * Franc, Zentralafrikanische Wirtschafts- und W�hrungsunion
   */
  public static final String XAF = "XAF";

  /**
   * Dollar, Ostkaribische W�hrungsunion
   */
  public static final String XCD = "XCD";

  /**
   * Sonderziehungsrecht - Internationaler W�hrungsfonds
   */
  public static final String XDR = "XDR";

  /**
   * Franc, Westafrikanische Wirtschafts- und W�hrungsunion
   */
  ...
  private static String[] waehrungen = { AED, AFN, ALL, AMD, ANG, AOA, ARS, AUD,
      AWG, AZN, BAM, BBD, BDT, BGN, BHD, BIF, BMD, BND, BOB, BRL, BSD, BTN, BWP,
      BYR, BZD, CAD, CDF, CHF, CLP, CNY, COP, CRC, CSD, CUP, CVE, CYP, CZK, DJF,
      DKK, DOP, DZD, EEK, EGP, ETB, ERN, EUR, FJD, FKP, GBP, GEL, GHC, GIP, GMD,
      ...
      MWK, MXN, MYR, MZM, NAD, NGN, NIO, NOK, NPR, NZD, OMR, PAB, PEN, PGK, PHP,
      PKR, PLN, PYG, QAR, RON, RUB, RWF, SAR, SBD, SCR, SDD, SEK, SGD, SHP, SIT,
      SKK, SLL, SOS, SRD, STD, SVC, SYP, SZL, THB, TJS, TMM, TND, TOP, TRY, TTD,
      TWD, TZS, UAH, UGX, USD, UYU, UZS, VEB, VND, VUV, WST, XAF, XCD, XDR, XOF,
      XPF, YER, ZAR, ZMK, ZWD };
