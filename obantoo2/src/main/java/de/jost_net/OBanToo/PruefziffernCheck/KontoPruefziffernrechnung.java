...
public final class KontoPruefziffernrechnung
{
   ...
   * Methode wird intern von HBCIUtils#checkAccountCRC(String,String) aufgerufen
   * und kann für Debugging-Zwecke auch direkt benutzt werden.
   * 
   * @param alg
   ...
   */
  public static PZRet checkAccountCRCByAlg(String alg, String blz,
